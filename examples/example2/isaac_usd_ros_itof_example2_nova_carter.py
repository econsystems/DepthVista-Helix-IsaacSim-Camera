...
# Point-cloud QoS: best_effort matches Nav2's sensor QoS and avoids reliable-delivery
# backpressure on the high-rate clouds.  (RViz's PointCloud2 display must then be set
# to Reliability: Best Effort.)  Change "bestEffort" -> "reliable" to revert.
POINTS_QOS = ('{"history":"keepLast","depth":5,"reliability":"bestEffort",'
...
def _setup_camera_graph(graph_path: str, cam_path: str, frame_id: str,
    ...
    _og_edit(graph_path, {
        ...
        og.Controller.Keys.SET_VALUES: [
            ...
            ("PC.inputs:qosProfile",         POINTS_QOS),
